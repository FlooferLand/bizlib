 ...
 * - FL
 */
public class LegacyRshowFormat implements IShowFormat {
    ...
    public @NotNull RawShowData read(@NotNull InputStream stream) {
        byte[] bytes;
        try {
        ...
        if (has_video) {
            System.out.println("Video data found");
        }

        return new RawShowData(signal_data, audio_data, video_data);
    }
